...
public class CertificateBasedStack extends software.amazon.awscdk.core.Stack implements JavaGradleStack {
    ...
    public static void main(String[] args) {
        new CertificateBasedStack(CdkHelper.getApp(), CdkHelper.getStackName());
    ...
    private Option<String> getCsrFileArgument() {
        return CdkHelper.getContextVariable(this, CSR_FILE_VARIABLE);
    }

    private Option<String> getDestroyArgument() {
        return CdkHelper.getContextVariable(this, DESTROY_VARIABLE);
    }

    private Option<String> getDesiredTopicArgument() {
        return CdkHelper.getContextVariable(this, DESIRED_TOPIC_VARIABLE);
    }
