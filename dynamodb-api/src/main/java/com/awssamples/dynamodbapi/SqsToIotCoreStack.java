package com.awssamples.dynamodbapi;
...
public class SqsToIotCoreStack extends software.amazon.awscdk.core.Stack implements JavaGradleStack {
    ...
    public static final String INBOUND_SQS_QUEUE_ARN_VARIABLE = "INBOUND_SQS_QUEUE_ARN";
    public static final String OUTBOUND_SQS_QUEUE_ARN_VARIABLE = "OUTBOUND_SQS_QUEUE_ARN";
    public static final String UUID_KEY_VARIABLE = "UUID_KEY";
    public static final String MESSAGE_ID_KEY_VARIABLE = "MESSAGE_ID_KEY";
    ...
    public static final String DEFAULT_UUID_NAME = "thingName";
    public static final String DEFAULT_MESSAGE_ID_NAME = "epochTime";
    public static final String MULTI_LEVEL_MQTT_WILDCARD = "#";
    public static final String REQUEST_TOPIC_PREFIX_NAME = "RequestTopicPrefix";
    public static final String RESPONSE_TOPIC_PREFIX_NAME = "ResponseTopicPrefix";
    public static final String DEFAULT_SELECT_CLAUSE = "select *, topic() as topic";
    public final String projectDirectory = "./";
    public final String outputJarName = "dynamodb-api-1.0-SNAPSHOT-all.jar";
    ...
    public static void main(String[] args) {
        new SqsToIotCoreStack(CdkHelper.getApp(), CdkHelper.getStackName());
    ...
    @NotNull
    private String getDefaultUuidNameAndWarn() {
        log.warn("No UUID key specified, using " + DEFAULT_UUID_NAME + " as default value");
        return DEFAULT_UUID_NAME;
    }

    @NotNull
    private String getDefaultMessageNameIdAndWarn() {
        log.warn("No message ID key specified, using " + DEFAULT_MESSAGE_ID_NAME + " as default value");
        return DEFAULT_MESSAGE_ID_NAME;
    }

    private Option<String> getInboundQueueArn() {
        return CdkHelper.getContextVariable(this, INBOUND_SQS_QUEUE_ARN_VARIABLE);
    }

    private Option<String> getOutboundQueueArn() {
        return CdkHelper.getContextVariable(this, OUTBOUND_SQS_QUEUE_ARN_VARIABLE);
    }

    private Option<String> getUuid() {
        return CdkHelper.getContextVariable(this, UUID_KEY_VARIABLE);
    }

    private Option<String> getMessageId() {
        Option<String> x = CdkHelper.getContextVariable(this, MESSAGE_ID_KEY_VARIABLE);
    ...
    private Queue buildInboundMessageQueue() {
        log.warn("Context variable [" + INBOUND_SQS_QUEUE_ARN_VARIABLE + "] not specified, using a default inbound SQS queue");
    ...
    private Queue buildOutboundMessageQueue() {
        log.warn("Context variable [" + OUTBOUND_SQS_QUEUE_ARN_VARIABLE + "] not specified, using a default outbound SQS queue");
    ...
    private Map<String, String> getGetMessageLambdaEnvironment() {
        return HashMap.of(GET + REQUEST_TOPIC_PREFIX_NAME, GET_REQUEST_TOPIC_PREFIX)
                .put(GET + RESPONSE_TOPIC_PREFIX_NAME, GET_RESPONSE_TOPIC_PREFIX);
    }

    private Map<String, String> getQueryMessageLambdaEnvironment() {
        return HashMap.of(QUERY + REQUEST_TOPIC_PREFIX_NAME, QUERY_REQUEST_TOPIC_PREFIX)
                .put(QUERY + RESPONSE_TOPIC_PREFIX_NAME, QUERY_RESPONSE_TOPIC_PREFIX);
    }

    private Map<String, String> getDeleteMessageLambdaEnvironment() {
        return HashMap.of(DELETE + REQUEST_TOPIC_PREFIX_NAME, DELETE_REQUEST_TOPIC_PREFIX)
                .put(DELETE + RESPONSE_TOPIC_PREFIX_NAME, DELETE_RESPONSE_TOPIC_PREFIX);
    }

    private Map<String, String> getNextMessageLambdaEnvironment() {
        return HashMap.of(NEXT + REQUEST_TOPIC_PREFIX_NAME, NEXT_REQUEST_TOPIC_PREFIX)
                .put(NEXT + RESPONSE_TOPIC_PREFIX_NAME, NEXT_RESPONSE_TOPIC_PREFIX);
    }

    private Map<String, String> getDevicesMessageLambdaEnvironment() {
        return HashMap.of(DEVICES + REQUEST_TOPIC_PREFIX_NAME, DEVICES_REQUEST_TOPIC)
                .put(DEVICES + RESPONSE_TOPIC_PREFIX_NAME, DEVICES_RESPONSE_TOPIC);
    }

    private Map<String, String> getSendMessageLambdaEnvironment(String outboundSqsQueueArn) {
        return HashMap.of(SEND + REQUEST_TOPIC_PREFIX_NAME, SEND_REQUEST_TOPIC_PREFIX)
                .put(SEND + RESPONSE_TOPIC_PREFIX_NAME, SEND_RESPONSE_TOPIC_PREFIX)
    ...
    private Function buildMoveFromSqsToDynamoDbLambda(String inboundSqsQueueArn, String uuidName, String messageIdName, Table table, Role role) {
        HashMap<String, String> environment = HashMap.<String, String>empty()
                .put(INBOUND_SQS_QUEUE_ARN, inboundSqsQueueArn)
                .put(DYNAMO_DB_TABLE_ARN, table.getTableArn())
                .put(UUID_KEY, uuidName)
                .put(MESSAGE_ID_KEY, messageIdName);
