...
import com.aws.samples.cdk.stacktypes.PythonStack;
...
public class AmazonIonStack extends software.amazon.awscdk.core.Stack implements PythonStack {
    ...
    private static final Logger log = LoggerFactory.getLogger(AmazonIonStack.class);

    @Inject
    LambdaPackagingHelper lambdaPackagingHelper;

    public static void main(String[] args) {
        new AmazonIonStack(CdkHelper.getApp(), CdkHelper.getStackName());

        CdkHelper.getApp().synth();
    }

    public AmazonIonStack(final Construct parent, final String name) {
        super(parent, name);
    ...
    @Override
    @NotNull
    public PythonLambdaFunctionDirectory getPythonLambdaFunctionDirectory() {
