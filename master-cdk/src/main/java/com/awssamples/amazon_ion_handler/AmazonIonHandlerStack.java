...
public class AmazonIonHandlerStack extends software.amazon.awscdk.core.Stack {
    ...
    public AmazonIonHandlerStack(final Construct parent, final String name) {
        ...
        Function ionMessageFunction = LambdaHelper.buildIotEventLambda(this, ION_MESSAGE, ionMessageRole, Runtime.PYTHON_3_7, HashMap.empty(), ionLambdaEnvironment, dualDeploymentPackage.toString(), ION_EVENT_HANDLER, LAMBDA_FUNCTION_TIMEOUT);
        ...
        Function jsonMessageFunction = LambdaHelper.buildIotEventLambda(this, JSON_MESSAGE, jsonMessageRole, Runtime.PYTHON_3_7, HashMap.empty(), jsonLambdaEnvironment, dualDeploymentPackage.toString(), JSON_EVENT_HANDLER, LAMBDA_FUNCTION_TIMEOUT);
