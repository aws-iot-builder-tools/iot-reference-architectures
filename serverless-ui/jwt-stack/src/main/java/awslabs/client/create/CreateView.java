...
import awslabs.client.PrettyPre;
...
import static awslabs.client.shared.JwtService.EXPIRATION_IN_SECONDS_MAX;
import static awslabs.client.shared.JwtService.EXPIRATION_IN_SECONDS_MIN;
    ...
    public void setup() {
        ...
        expirationInSeconds.addValidator(new Validator<String>() {
            ...
            public List<EditorError> validate(Editor<String> editor, String value) {
                ...
                if (intValue < EXPIRATION_IN_SECONDS_MIN) {
                    // Too low
                    errors.add(new BasicEditorError(editor, value, "Value is below the minimum [" + EXPIRATION_IN_SECONDS_MIN + "]"));
                } else if (intValue > EXPIRATION_IN_SECONDS_MAX) {
                    // Too high
                    errors.add(new BasicEditorError(editor, value, "Value is above the maximum [" + EXPIRATION_IN_SECONDS_MAX + "]"));
                }
