...
public class NewTerminalWidget {
    ...
    public interface Handler extends EventHandler {
        void onNewTerminalWidget(Event newTerminalWidgetEvent);
    }

    public static class Event extends GwtEvent<NewTerminalWidget.Handler> {
        ...
        protected void dispatch(Handler handler) {
            handler.onNewTerminalWidget(this);
        }
    }
}
